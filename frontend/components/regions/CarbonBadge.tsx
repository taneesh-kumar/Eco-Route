...
export function CarbonBadge({
  ...
  const titleInfo = [
    ...
    isEstimated || quality === "LIVE_ESTIMATED" ? `Estimated: Yes (${estimationMethod || "Electricity Maps Live Model"})` : "Estimated: No",
  ].join(" | ");
  ...
  return (
    ...
    >
      ...
      <span className="font-semibold font-mono">
        {numIntensity.toFixed(2)} <span className="text-[10px] font-sans font-normal opacity-80">gCO₂eq/kWh</span>
      </span>
